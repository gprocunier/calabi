...
LOG_PATH="${LOG_PATH:-/var/tmp/bastion-playbooks-onprem/mirror-registry.log}"
RC_PATH="${RC_PATH:-/var/tmp/bastion-playbooks-onprem/mirror-registry.rc}"
...
SUMMARY_TOOL="${SUMMARY_TOOL:-/usr/local/bin/track-mirror-progress-onprem}"
